...
async function displayTrains(){
    let table = "<table border = '1'><tr><th>Route Name</th><th>Train Number</th><th>Origin</th><th>Destination</th><th>Scheduled Departure Time</th></tr>";
    ...
    for(let i = 0; i < station.NCR.trains.length; i++){
        ...
        </td><td>${train.stations.find(station => station.name === "New Carrollton").schDep}</td></tr>`;
    }
    return table;
}